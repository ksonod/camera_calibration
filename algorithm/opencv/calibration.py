        ...
        for i in range(num_valid_files):
            ...
            if self.show_figure:
                ...
                show_cb_image_with_detected_corners(
                    img=img, detected_points=np.squeeze(points2d[i]), figure_title=self.img_file_list[i].name
                )
            ...
            reprojection_error.append(
                self.calculate_reprojection_error(reference_points2d=points2d[i], projected_points2d=projected_points2d)
            )
