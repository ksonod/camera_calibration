...
This Python script currently supports three implementations: **OpenCV-based** [[1](https://docs.opencv.org/4.x/dc/dbb/tutorial_py_calibration.html)], **MATLAB-based** [[2](https://mathworks.com/help/vision/ref/estimatecameraparameters.html)], and **Zhang's closed-solution** [[3](https://ieeexplore.ieee.org/document/888718)] methods.

# How to Use
The `main.py` code is very simple as shown below:
<img src="./docs/images/input_example.png" width="1400">   
For now, `CalibMethod.MATLAB`, `CalibMethod.OPENCV`, or `CalibMethod.ZHANG2000` can be selected as a method. Once you specify the `CONFIG` dictionary, you can simply run this code. Please note that all input images should contain a checkerboard with good visibility and be stored in the `./data` folder.  
...
- **Zhang's method**: This is a Python implementation built from scratch based on the original paper of Zhang [[3](https://ieeexplore.ieee.org/document/888718)]. By solving closed-form equations, intrinsics and extrinsics parameters can be determined. Because of its simpleness, it is possible to modify it easily.

OpenCV-based and MATLAB-based methods serve as references. In general, these methods give almost the same results. 
...
See also [[3](https://mathworks.com/help/vision/ug/camera-calibration.html)] and [[5](https://ieeexplore.ieee.org/document/888718)]. 
